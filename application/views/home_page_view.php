    <?php
      // Load Menu
      $this->template->menu(1);
    ?>
    <div class="jumbotron">
      <div class="container">
        <h1>Welcome to the Test</h1>
        <p>We're going to build a cool application using a MVC framework! This application was built by Jason Taylor in association with the Village88 folks!</p>
        <p><a href="login" class="btn btn-primary btn-lg" role="button">Start &raquo;</a></p>
      </div>
    </div>
